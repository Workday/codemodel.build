...
/**
 * A {@code yield} statement in a {@code switch} expression case: {@code yield expr}.
 *
...
public final class Yield
    ...
    /**
     * The expression producing the value yielded by the enclosing {@code switch} expression.
     */
    private final Expression expression;

    private Yield(final Expression expression) {
        super(Objects.requireNonNull(expression, "expression must not be null").codeModel());
        this.expression = expression;
    }

    @Unmarshal
    public Yield(@Bound final CodeModel codeModel,
    ...
    /**
     * Obtains the expression producing the yielded value.
     *
    ...
    public boolean equals(final Object object) {
        return object instanceof Yield other
            && Objects.equals(this.expression, other.expression)
            && super.equals(other);
    }

    /**
     * Creates a {@link Yield} statement.
     *
     * @param expression the yielded {@link Expression}
     * @return a new {@link Yield}
     */
    public static Yield of(final Expression expression) {
        return new Yield(expression);
    }

    static {
        Marshalling.register(Yield.class, MethodHandles.lookup());
    }
}
