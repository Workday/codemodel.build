...
/**
 * Defines a <i>Less Than or Equal To</i> {@link LogicalExpression} between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class LessThanOrEqualTo
    ...
    /**
     * Un{@link Marshal} a {@link LessThanOrEqualTo}.
     *
     ...
     */
    @Unmarshal
    public LessThanOrEqualTo(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link LessThanOrEqualTo}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof LessThanOrEqualTo other
            && super.equals(other);
    }
     ...
     * @param right the right-hand-side {@link Expression}
     */
    public static LessThanOrEqualTo of(final Expression left,
                                       final Expression right) {
    ...
    static {
        Marshalling.register(LessThanOrEqualTo.class, MethodHandles.lookup());
    }
}
