...
/**
 * Defines an exclusive <a href="https://en.wikipedia.org/wiki/Logical_disjunction">Disjunction</a> (xor) of two
...
public class ExclusiveDisjunction
    ...
    /**
     * Un{@link Marshal} an {@link ExclusiveDisjunction}.
     *
     ...
     */
    @Unmarshal
    public ExclusiveDisjunction(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} an {@link ExclusiveDisjunction}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof ExclusiveDisjunction other
            && super.equals(other);
    }

    /**
     * Creates a {@link ExclusiveDisjunction} of two {@link Expression}s.
     *
     * @param left  the left-hand-side {@link Expression}
     * @param right the right-hand-side {@link Expression}
     */
    public static ExclusiveDisjunction of(final Expression left,
                                          final Expression right) {
    ...
    static {
        Marshalling.register(ExclusiveDisjunction.class, MethodHandles.lookup());
    }
}
