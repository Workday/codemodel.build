...
/**
 * Defines an <i>Any In Common</i> {@link ComparisonExpression} between two {@link Expression}s.
 *
 * @author tim.berston
 * @since Feb-2025
 */
public class AnyInCommon
    ...
    /**
     * Un{@link Marshal} an {@link AnyInCommon}.
     *
     ...
     */
    @Unmarshal
    public AnyInCommon(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} an {@link AnyInCommon}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof AnyInCommon other
            && super.equals(other);
    }

    /**
     * Creates a {@link AnyInCommon} of two {@link Expression}s.
     *
     * @param left  the left-hand-side {@link Expression}
     * @param right the right-hand-side {@link Expression}
     */
    public static AnyInCommon of(final Expression left,
                                 final Expression right) {

        return new AnyInCommon(left, right);
    }
    
    static {
        Marshalling.register(AnyInCommon.class, MethodHandles.lookup());
    }
}
