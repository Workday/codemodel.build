...
/**
 * Defines a <i>Less Than</i> {@link LogicalExpression} between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class LessThan
    ...
    /**
     * Un{@link Marshal} a {@link LessThan}.
     *
     ...
     */
    @Unmarshal
    public LessThan(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof LessThan other
            && super.equals(other);
    }
     ...
     * @param right the right-hand-side {@link Expression}
     */
    public static LessThan of(final Expression left,
                              final Expression right) {
    ...
    static {
        Marshalling.register(LessThan.class, MethodHandles.lookup());
    }
}
