...
/**
 * Defines an <a href="https://en.wikipedia.org/wiki/Addition">Addition</a> between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class Addition
     ...
     */
    private Addition(final Expression left,
    ...
    /**
     * Un{@link Marshal} an {@link Addition}.
     *
     ...
     */
    @Unmarshal
    public Addition(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof Addition other
            && super.equals(other);
    }
     ...
     */
    public static Addition of(final Expression left,
                              final Expression right) {
    ...
    static {
        Marshalling.register(Addition.class, MethodHandles.lookup());
    }
}
