...
/**
 * Defines an equality {@link LogicalExpression} between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class EqualTo
    ...
    /**
     * Un{@link Marshal} an {@link EqualTo}.
     *
     ...
     */
    @Unmarshal
    public EqualTo(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof EqualTo other
            && super.equals(other);
    }
     ...
     * @param right the right-hand-side {@link Expression}
     */
    public static EqualTo of(final Expression left,
                             final Expression right) {
    ...
    static {
        Marshalling.register(EqualTo.class, MethodHandles.lookup());
    }
}
