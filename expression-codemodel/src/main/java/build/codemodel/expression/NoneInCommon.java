...
/**
 * Defines a <i>None In Common</i> {@link ComparisonExpression} between two {@link Expression}s.
 *
 * @author tim.berston
 * @since Feb-2025
 */
public class NoneInCommon
    extends AbstractComparisonExpression {

    /**
     * Constructs a {@link NoneInCommon}.
     *
     * @param left  the left-hand-side {@link Expression}
     * @param right the right-hand-side {@link Expression}
     */
    private NoneInCommon(final Expression left,
    ...
    /**
     * Un{@link Marshal} a {@link NoneInCommon}.
     *
     * @param codeModel the {@link CodeModel}
     * @param marshaller the {@link Marshaller}
     * @param traits     the {@link Stream} of {@link Marshalled} {@link Trait}s
     * @param typeUsage  the {@link Optional} {@link TypeUsage}
     ...
     */
    @Unmarshal
    public NoneInCommon(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link NoneInCommon}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof NoneInCommon other
            && super.equals(other);
    }

    /**
     * Creates a {@link NoneInCommon} of two {@link Expression}s.
     *
     * @param left  the left-hand-side {@link Expression}
     * @param right the right-hand-side {@link Expression}
     */
    public static NoneInCommon of(final Expression left,
                                  final Expression right) {

        return new NoneInCommon(left, right);
    }
    
    static {
        Marshalling.register(NoneInCommon.class, MethodHandles.lookup());
    }
}
