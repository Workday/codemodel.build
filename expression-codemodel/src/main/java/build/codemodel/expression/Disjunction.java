...
/**
 * Defines a <a href="https://en.wikipedia.org/wiki/Logical_disjunction">Disjunction</a> (or) of two
...
public class Disjunction
    ...
    /**
     * Un{@link Marshal} a {@link Disjunction}.
     *
     ...
     */
    @Unmarshal
    public Disjunction(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link Disjunction}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof Disjunction other
            && super.equals(other);
    }

    /**
     * Creates a {@link Disjunction} of two {@link Expression}s.
     *
     * @param left  the left-hand-side {@link Expression}
     * @param right the right-hand-side {@link Expression}
     */
    public static Disjunction of(final Expression left,
                                 final Expression right) {
    ...
    static {
        Marshalling.register(Disjunction.class, MethodHandles.lookup());
    }
}
