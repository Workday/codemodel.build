...
/**
 * Defines a <a href="https://en.wikipedia.org/wiki/Multiplication">Division</a> between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class Division
    ...
    /**
     * Un{@link Marshal} a {@link Division}.
     *
     ...
     */
    @Unmarshal
    public Division(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof Division other
            && super.equals(other);
    }
     ...
     */
    public static Division of(final Expression left,
                              final Expression right) {
    ...
    static {
        Marshalling.register(Division.class, MethodHandles.lookup());
    }
}
