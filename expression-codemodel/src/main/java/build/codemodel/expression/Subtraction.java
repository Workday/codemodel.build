...
/**
 * Defines a <a href="https://en.wikipedia.org/wiki/Subtraction">Subtraction</a> between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class Subtraction
    ...
    /**
     * Un{@link Marshal} a {@link Subtraction}.
     *
     ...
     */
    @Unmarshal
    public Subtraction(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link Subtraction}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof Subtraction other
            && super.equals(other);
    }
     ...
     */
    public static Subtraction of(final Expression left,
                                 final Expression right) {
    ...
    static {
        Marshalling.register(Subtraction.class, MethodHandles.lookup());
    }
}
