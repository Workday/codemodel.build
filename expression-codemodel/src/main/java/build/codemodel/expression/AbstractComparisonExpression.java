...
/**
 * An abstract {@link ComparisonExpression}.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public abstract class AbstractComparisonExpression
    ...
    /**
     * Constructs an {@link AbstractComparisonExpression}.
     *
     * @param left  left-hand-side {@link Expression}
     * @param right right-hand-side {@link Expression}
     */
    protected AbstractComparisonExpression(final Expression left,
    ...
    /**
     * {@link Unmarshal} an {@link AbstractComparisonExpression}.
     *
     ...
     */
    protected AbstractComparisonExpression(final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} an {@link AbstractComparisonExpression}.
     *
     * @param marshaller the {@link Marshaller} for unmarshalling the {@link Marshalled} {@link Trait}s
     * @param traits     the {@link Marshalled} {@link Trait}s
     * @param typeUsage  the {@link Optional} {@link Marshalled} {@link TypeUsage}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof AbstractComparisonExpression other
