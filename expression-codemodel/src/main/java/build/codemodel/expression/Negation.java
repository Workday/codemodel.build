...
/**
 * Defines a <a href="https://en.wikipedia.org/wiki/Negation">Negation</a> (not) of an {@link Expression}.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class Negation
    extends AbstractUnaryLogicalExpression {

    /**
     * Constructs a {@link Negation}.
     *
     * @param expression the {@link LogicalExpression} to negate
     */
    private Negation(final Expression expression) {
        super(expression);
    }

    /**
     * Un{@link Marshal} a {@link Negation}.
     *
     ...
     */
    @Unmarshal
    public Negation(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof Negation other
            && super.equals(other);
    }

    /**
     * Creates a {@link Negation} of an {@link LogicalExpression}.
     *
     * @param expression the {@link LogicalExpression} to negate
     */
    public static Negation of(final Expression expression) {
        return new Negation(expression);
    }

    static {
        Marshalling.register(Negation.class, MethodHandles.lookup());
    }
}
