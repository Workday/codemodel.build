...
public class NotEqualTo
    ...
    /**
     * Un{@link Marshal} a {@link NotEqualTo}.
     *
     ...
     */
    @Unmarshal
    public NotEqualTo(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link NotEqualTo}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof NotEqualTo other
            && super.equals(other);
    }
     ...
     * @param right the right-hand-side {@link Expression}
     */
    public static NotEqualTo of(final Expression left,
                                final Expression right) {
    ...
    static {
        Marshalling.register(NotEqualTo.class, MethodHandles.lookup());
    }
}
