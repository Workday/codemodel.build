...
/**
 * Defines a <i>Greater Than</i> {@link LogicalExpression} between two {@link Expression}s.
 *
 * @author brian.oliver
 * @since Sep-2024
 */
public class GreaterThan
    ...
    /**
     * Un{@link Marshal} a {@link GreaterThan}.
     *
     ...
     */
    @Unmarshal
    public GreaterThan(@Bound final CodeModel codeModel,
    ...
    /**
     * {@link Marshal} a {@link GreaterThan}.
     *
     * @param marshaller the {@link Marshaller}
    ...
    public boolean equals(final Object object) {
        ...
        return object instanceof GreaterThan other
            && super.equals(other);
    }
     ...
     * @param right the right-hand-side {@link Expression}
     */
    public static GreaterThan of(final Expression left,
                                 final Expression right) {
    ...
    static {
        Marshalling.register(GreaterThan.class, MethodHandles.lookup());
    }
}
