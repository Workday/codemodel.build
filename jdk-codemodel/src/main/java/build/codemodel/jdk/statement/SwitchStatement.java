...
/**
 * A {@code switch} statement: {@code switch (selector) { cases }}.
 *
...
public final class SwitchStatement
    ...
    /**
     * The selector expression evaluated to determine which case to execute.
     */
    ...
    private SwitchStatement(final Expression selector, final Stream<SwitchCase> cases) {
    ...
    @Unmarshal
    public SwitchStatement(@Bound final CodeModel codeModel,
    ...
    /**
     * Obtains the cases in the switch body.
     *
    ...
    public boolean equals(final Object object) {
        return object instanceof SwitchStatement other
     ...
     * @return a new {@link SwitchStatement}
     */
    public static SwitchStatement of(final Expression selector, final Stream<SwitchCase> cases) {
        return new SwitchStatement(selector, cases);
    }

    static {
        Marshalling.register(SwitchStatement.class, MethodHandles.lookup());
    }
}
