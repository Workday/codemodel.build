...
/**
 * A {@code break} statement: {@code break [label]}.
 *
...
public final class Break
    ...
    private Break(final CodeModel codeModel, final Optional<String> label) {
        super(codeModel);
        this.label = label == null ? Optional.empty() : label;
    }

    @Unmarshal
    public Break(@Bound final CodeModel codeModel,
    ...
    public boolean equals(final Object object) {
        return object instanceof Break other
    ...
    public static Break of(final CodeModel codeModel, final Optional<String> label) {
        return new Break(Objects.requireNonNull(codeModel, "codeModel must not be null"), label);
    }

    static {
        Marshalling.register(Break.class, MethodHandles.lookup());
    }
}
