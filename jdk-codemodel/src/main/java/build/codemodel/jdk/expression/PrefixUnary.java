...
/**
 * A prefix unary expression: {@code ++x}, {@code --x}, {@code ~x}, {@code +x}.
 *
 * @author reed.vonredwitz
 * @since Mar-2026
 */
public final class PrefixUnary
    ...
    @Unmarshal
    public PrefixUnary(@Bound final CodeModel codeModel,
    ...
    static {
        Marshalling.register(PrefixUnary.class, MethodHandles.lookup());
    }
}
