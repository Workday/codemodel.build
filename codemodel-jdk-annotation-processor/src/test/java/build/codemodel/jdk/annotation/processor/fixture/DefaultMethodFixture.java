...
/**
 * An interface fixture with a {@code default} method, used to assert that the {@code Default}
 * trait agrees across all three member-population paths.
 *
 * @see build.codemodel.jdk.annotation.processor.MemberPopulationParityTests
 */
@Discoverable
public interface DefaultMethodFixture {
