...
/**
 * A fixture declaring nested member types, used to assert that {@code MemberTypeDescriptor} names
 * agree across all three member-population paths.
 *
 * @see build.codemodel.jdk.annotation.processor.MemberPopulationParityTests
 */
@Discoverable
public class NestedTypeFixture {
